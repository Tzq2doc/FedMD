...
def cnn_3layer_fc_model(n_classes = 10,n1 = 128, n2=192, n3=256, dropout_rate = 0.2,input_shape = (28,28)):
    model_A, x = None, None
...
def cnn_2layer_fc_model(n_classes = 10,n1 = 128, n2=256, dropout_rate = 0.2,input_shape = (28,28)):
    model_A, x = None, None
